...
export default function WelcomePage() {
  ...
  const yHero = useTransform(scrollY, [0, 300], [100, -500]);
  const opacityHero = useTransform(scrollY, [0, 200, 600], [1, 1, 0]);
  const scale = useTransform(scrollY, [0, 300], [1, 1.5]);

  return (
    <>
      <header id="welcome-header">
        <motion.div style={{ scale: scale }} id="welcome-header-content">
